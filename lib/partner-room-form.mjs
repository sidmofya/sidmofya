 ...
 */
export function validateRoomRequest(values) {
 ...
 * @returns {Record<string, string>}
 */
export function buildRoomRequestPayload(values, attribution, submittedAt) {
  return {
    ...
    "raise-amount": values["raise-amount"] ?? "",
    ...
    subject: `Partner Room request — ${values.company}`,
